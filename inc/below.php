			...
			<!-- Film Section -->
			<section class="film-section fill-light-2">
				<div class="row">
					<div class="container fill-light-1 block-space-top-bottom">
						...
						<div class="columns small-12 large-6">
							<div class="content row flex-center block-space-top-bottom">
								<div class="columns small-10 small-offset-1 medium-6 medium-offset-3 large-8 large-offset-2">
									...
									<hr class="underline">
									<div class="p">The 'Aircraft Wing Section' shape of each building tower is not an accident. It accounts for a marked improvement in airflow as compared to a traditional 'Box Shaped' building.</div>
								</div>
							</div>
						</div>
					</div>
